...
const MainScreen = () => {
    ...
    return (
        <div
            ...
            className="w-screen bg-no-repeat bg-contain bg-bottom pt-16 md:pt-24 lg:pt-32 xl:pt-16 2xl:pt-16"
        >
            <div className="flex">
                <div className="lg:w-2/3 px-10 py-0  2xl:py-8">
                    <div style={titleAnimation} className="w-full">
                        <h1 className="text-5xl sm:text-6xl font-Line-bd text-rose-400">イチゴ</h1>
                        ...
                        <NavLink
                            ...
                            className="mt-9 md:mt-8 2xl:mt-4 text-xl leading-none text-gray-800 flex  hover:text-red-300  font-Line-bd right"
                        >
                            買いに行く
                        </NavLink>
                    </div>
