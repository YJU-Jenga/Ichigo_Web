        ...
        <div className="h-screen">
            <BrowserRouter>
                ...
                <Routes>
                    ...
                    <Route path="/write_item_use" element={<WriteItemUseScreen user={user} />} />
                    ...
                    <Route path="/addclothes" element={<AddClothesScreen user={user} />} />
                    <Route path="/calendar" element={<CalendarScreen user={user} />} />
                    <Route path="/maniging" element={<ManigingScreen user={user} />} />
                    <Route path="/maniging_device" element={<ManigingDeviceScreen user={user} />} />
